...
const lut = {
  ...
  unmap_bndl_l: f => {
    ...
    if (
      f.properties.iso3cd == 'COL' ||
      f.properties.iso3cd == 'COL_ECU' ||
      f.properties.iso3cd == 'COL_PER' ||
      f.properties.iso3cd == 'COL_VEN' ||
      f.properties.iso3cd == 'BRA_COL' ||
      f.properties.iso3cd == 'COL_PAN' ||
      f.properties.iso3cd == 'COL_PAN' ||
      f.properties.iso3cd == 'BGD_MMR' ||
      f.properties.iso3cd == 'CHN_MMR' ||
      f.properties.iso3cd == 'IND_MMR' ||
      f.properties.iso3cd == 'LAO_MMR' ||
      f.properties.iso3cd == 'MMR' ||
      f.properties.iso3cd == 'MMR_THA'
    ) {
      return null;
    } else {
  ...
  un_glc30_global_lc_ms_a: f => {
    ...
    if (
      f.properties.gridcode == 20 ||
      f.properties.gridcode == 30 ||
      f.properties.gridcode == 80
    ) {
